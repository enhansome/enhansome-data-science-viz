...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,043 | 🐛 25 | 🌐 Python | 📅 2026-08-11 comprehensive list of machine learning resources
...
* [Probabilistic Programming and Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,166 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python
...
* [Scikit Learn](https://github.com/scikit-learn/scikit-learn) ⭐ 66,963 | 🐛 2,127 | 🌐 Python | 📅 2026-08-17 is a Python module for machine learning built on top of [SciPy](https://www.scipy.org/)
* [Keras](https://github.com/fchollet/keras) ⭐ 64,239 | 🐛 222 | 🌐 Python | 📅 2026-08-14 Deep Learning library for [Theano][], [TensorFlow][] and [CNTK][].
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,562 | 🐛 1,566 | 🌐 C++ | 📅 2024-07-31 deep learning framework made with expression, speed, and modularity in mind. Written in C++ and has python bindings.
* [XGboost](https://github.com/dmlc/xgboost) ⭐ 28,661 | 🐛 418 | 🌐 C++ | 📅 2026-08-18 an optimized distributed gradient boosting library designed to be highly efficient, flexible and portable. Written in C++ with python integration.
...
* [Torch](https://github.com/torch/torch7) ⭐ 9,139 | 🐛 298 | 🌐 C | 📅 2025-03-31 provides several tools for fast tensor mathematics, storage interfaces and machine learning models. Written in C with Lua interface.
* [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit) ⭐ 8,704 | 🐛 6 | 🌐 C++ | 📅 2026-08-18 is a machine learning system which pushes the frontier of machine learning with techniques such as online, hashing, allreduce, reductions, learning2search, active, and interactive learning. Writtent in C++ with bindings for python and other languages.
...
* [OpenNN](https://github.com/Artelnics/OpenNN) ⭐ 1,198 | 🐛 0 | 🌐 C++ | 📅 2026-08-17 a neural network C++ library
...
* [TensorFlow Examples](https://github.com/aymericdamien/TensorFlow-Examples) ⭐ 43,732 | 🐛 228 | 🌐 Jupyter Notebook | 📅 2024-07-26 a [TensorFlow][] tutorial with popular machine learning algorithms implementation
...
* [huggingface/transformers](https://github.com/huggingface/transformers) ⭐ 164,195 | 🐛 2,387 | 🌐 Python | 📅 2026-08-18 State-of-the-art Natural Language Processing for Pytorch and TensorFlow 2.0
* [SpaCy](https://github.com/spacy-io/spaCy) ⭐ 33,826 | 🐛 234 | 🌐 Python | 📅 2026-08-07 is a powerful, production ready, NLP library for python
* [fastText](https://github.com/facebookresearch/fastText) ⚠️ Archived a C++ library for sentence classification
* [Natural Language Toolkit](https://github.com/nltk/nltk) ⭐ 14,697 | 🐛 228 | 🌐 Python | 📅 2026-08-17 (NLTK) is a suite of python modules, data sets and tutorials supporting research and development in [NLP][]. Some of its modules are out of date but still a useful resource nonetheless.
* [TextBlob](https://github.com/sloria/TextBlob) ⭐ 9,544 | 🐛 72 | 🌐 Python | 📅 2026-08-17 is a python library for processing textual data. It provides a simple API for diving into common [NLP][] tasks such as part-of-speech tagging, noun phrase extraction, sentiment analysis, classification, translation, and more.
...
* [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,294 | 🐛 850 | 🌐 JavaScript | 📅 2026-08-17 charting library built on top of [d3][] and [stack.gl](http://stack.gl/)
* [frappe/charts](https://github.com/frappe/charts) ⭐ 15,084 | 🐛 145 | 🌐 JavaScript | 📅 2025-07-02 Simple, responsive, modern SVG Charts with zero dependencies
...
* [dash](https://github.com/plotly/dash/) ⭐ 24,374 | 🐛 538 | 🌐 Python | 📅 2026-08-17 Dash is a Python framework for building analytical web applications
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 314,515 | 🐛 16 | 🌐 Python | 📅 2026-08-16 A curated list of awesome Python frameworks, libraries, software and resources.
* [Interactive coding challenges](https://github.com/donnemartin/interactive-coding-challenges) ⭐ 31,731 | 🐛 75 | 🌐 Python | 📅 2024-05-08 which focus on algorithms and data structures that are typically found in coding interviews
