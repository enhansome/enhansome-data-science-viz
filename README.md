...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,410 | 🐛 20 | 🌐 Python | 📅 2026-09-22 comprehensive list of machine learning resources
* [Python data-science handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,982 | 🐛 226 | 🌐 Jupyter Notebook | 📅 2024-06-26
* [Deep Learning Papers Reading Roadmap](https://github.com/songrotek/Deep-Learning-Papers-Reading-Roadmap) ⭐ 39,572 | 🐛 93 | 🌐 Python | 📅 2022-11-27
* [Data science ipython notebooks](https://github.com/donnemartin/data-science-ipython-notebooks) ⭐ 29,355 | 🐛 48 | 🌐 Python | 📅 2024-03-20
* [Probabilistic Programming and Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,193 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 An introduction to Bayesian methods + probabilistic programming with a computation/understanding-first, mathematics-second point of view. All in pure Python
...
* [TopDeepLearning](https://github.com/aymericdamien/TopDeepLearning) ⭐ 6,356 | 🐛 20 | 🌐 Python | 📅 2026-07-15 is a list of popular github projects related to deep learning (ranked by stars)

### Frameworks

* [Scikit Learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,351 | 🐛 2,155 | 🌐 Python | 📅 2026-09-22 is a Python module for machine learning built on top of [SciPy](https://www.scipy.org/)
* [Keras](https://github.com/fchollet/keras) ⭐ 64,330 | 🐛 244 | 🌐 Python | 📅 2026-09-23 Deep Learning library for [Theano][], [TensorFlow][] and [CNTK][].
...
* [XGboost](https://github.com/dmlc/xgboost) ⭐ 28,786 | 🐛 436 | 🌐 C++ | 📅 2026-09-22 an optimized distributed gradient boosting library designed to be highly efficient, flexible and portable. Written in C++ with python integration.
...
* [OpenNN](https://github.com/Artelnics/OpenNN) ⭐ 1,198 | 🐛 0 | 🌐 C++ | 📅 2026-09-22 a neural network C++ library
...
* [TFLearn](https://github.com/tflearn/tflearn) ⭐ 9,573 | 🐛 579 | 🌐 Python | 📅 2024-05-06 is a deep learning library featuring a higher-level API for [TensorFlow][].
...
* [TensorFlow Examples](https://github.com/aymericdamien/TensorFlow-Examples) ⭐ 43,743 | 🐛 229 | 🌐 Jupyter Notebook | 📅 2024-07-26 a [TensorFlow][] tutorial with popular machine learning algorithms implementation
* [AIMA python](https://github.com/aimacode/aima-python) ⭐ 8,837 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-06-30 Python code for the book [Artificial Intelligence: A Modern Approach](https://www.amazon.co.uk/Artificial-Intelligence-Approach-Stuart-Russell/dp/1292153962)
...
* [huggingface/transformers](https://github.com/huggingface/transformers) ⭐ 166,553 | 🐛 2,400 | 🌐 Python | 📅 2026-09-23 State-of-the-art Natural Language Processing for Pytorch and TensorFlow 2.0
* [SpaCy](https://github.com/spacy-io/spaCy) ⭐ 33,916 | 🐛 245 | 🌐 Python | 📅 2026-08-24 is a powerful, production ready, NLP library for python
* [fastText](https://github.com/facebookresearch/fastText) ⚠️ Archived a C++ library for sentence classification
* [Natural Language Toolkit](https://github.com/nltk/nltk) ⭐ 14,724 | 🐛 260 | 🌐 Python | 📅 2026-09-21 (NLTK) is a suite of python modules, data sets and tutorials supporting research and development in [NLP][]. Some of its modules are out of date but still a useful resource nonetheless.
* [TextBlob](https://github.com/sloria/TextBlob) ⭐ 9,549 | 🐛 71 | 🌐 Python | 📅 2026-09-22 is a python library for processing textual data. It provides a simple API for diving into common [NLP][] tasks such as part-of-speech tagging, noun phrase extraction, sentiment analysis, classification, translation, and more.
* [langdetect](https://github.com/Mimino666/langdetect) ⭐ 1,903 | 🐛 72 | 🌐 Python | 📅 2025-03-03 is a port of Google's language-detection library to Python.
...
* [dataprofiler](https://github.com/capitalone/DataProfiler) ⭐ 1,587 | 🐛 80 | 🌐 Python | 📅 2026-09-14 The DataProfiler is a Python library designed to make data analysis, monitoring and sensitive data detection easy. NLP processing is accomplished using a character-level CNN.
...
* [CovNetJS](https://github.com/karpathy/convnetjs) ⭐ 11,203 | 🐛 75 | 🌐 JavaScript | 📅 2023-01-07 train Convolutional Neural Networks (or ordinary ones) in the browser
...
* [match](https://github.com/usepavlov/match) ⭐ 1,264 | 🐛 17 | 🌐 Python | 📅 2020-07-25 makes it easy to search for images that look similar to each other
...
* [Newspaper](https://github.com/codelucas/newspaper) ⭐ 15,162 | 🐛 516 | 🌐 Python | 📅 2026-09-15 News, full-text, and article metadata extraction in Python 3.

### Explore

* [Crossfilter](https://github.com/square/crossfilter) ⭐ 6,186 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-04 is a JavaScript library for exploring large multivariate datasets in the browser.

### Storage

* [pytables](https://github.com/PyTables/PyTables) ⭐ 1,372 | 🐛 152 | 🌐 Python | 📅 2026-09-18 a package for managing hierarchical datasets and designed to efficiently cope with extremely large amounts of data. It is built on top of the [HDF5][] library and the NumPy package.
...
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,714 | 🐛 583 | 🌐 JavaScript | 📅 2026-09-14 HTML5 Charts using the canvas tag
* [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,339 | 🐛 784 | 🌐 JavaScript | 📅 2026-09-22 charting library built on top of [d3][] and [stack.gl](http://stack.gl/)
* [frappe/charts](https://github.com/frappe/charts) ⭐ 15,083 | 🐛 147 | 🌐 JavaScript | 📅 2025-07-02 Simple, responsive, modern SVG Charts with zero dependencies
* [G2](https://github.com/antvis/g2) ⭐ 12,616 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-22 is a visualization grammar, a data-driven visual language with a high level of usability and scalability
...
* [dash](https://github.com/plotly/dash/) ⭐ 24,425 | 🐛 433 | 🌐 Python | 📅 2026-09-22 Dash is a Python framework for building analytical web applications
* [bqplot](https://github.com/bloomberg/bqplot) ⭐ 3,692 | 🐛 279 | 🌐 TypeScript | 📅 2026-05-07 plotting library for IPython/Jupyter notebooks - front-end in [d3][]
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 322,408 | 🐛 21 | 🌐 Python | 📅 2026-09-22 A curated list of awesome Python frameworks, libraries, software and resources.
* [Interactive coding challenges](https://github.com/donnemartin/interactive-coding-challenges) ⭐ 31,846 | 🐛 75 | 🌐 Python | 📅 2024-05-08 which focus on algorithms and data structures that are typically found in coding interviews
