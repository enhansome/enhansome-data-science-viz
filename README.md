...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,382 | 🐛 30 | 🌐 Python | 📅 2026-09-17 comprehensive list of machine learning resources
* [Python data-science handbook](https://github.com/jakevdp/PythonDataScienceHandbook) ⭐ 49,949 | 🐛 226 | 🌐 Jupyter Notebook | 📅 2024-06-26
* [Deep Learning Papers Reading Roadmap](https://github.com/songrotek/Deep-Learning-Papers-Reading-Roadmap) ⭐ 39,563 | 🐛 91 | 🌐 Python | 📅 2022-11-27
...
* [TopDeepLearning](https://github.com/aymericdamien/TopDeepLearning) ⭐ 6,355 | 🐛 20 | 🌐 Python | 📅 2026-07-15 is a list of popular github projects related to deep learning (ranked by stars)

### Frameworks

* [Scikit Learn](https://github.com/scikit-learn/scikit-learn) ⭐ 67,328 | 🐛 2,168 | 🌐 Python | 📅 2026-09-19 is a Python module for machine learning built on top of [SciPy](https://www.scipy.org/)
* [Keras](https://github.com/fchollet/keras) ⭐ 64,324 | 🐛 218 | 🌐 Python | 📅 2026-09-19 Deep Learning library for [Theano][], [TensorFlow][] and [CNTK][].
...
* [XGboost](https://github.com/dmlc/xgboost) ⭐ 28,783 | 🐛 436 | 🌐 C++ | 📅 2026-09-20 an optimized distributed gradient boosting library designed to be highly efficient, flexible and portable. Written in C++ with python integration.
...
* [Torch](https://github.com/torch/torch7) ⭐ 9,140 | 🐛 299 | 🌐 C | 📅 2025-03-31 provides several tools for fast tensor mathematics, storage interfaces and machine learning models. Written in C with Lua interface.
* [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit) ⭐ 8,720 | 🐛 2 | 🌐 C++ | 📅 2026-09-20 is a machine learning system which pushes the frontier of machine learning with techniques such as online, hashing, allreduce, reductions, learning2search, active, and interactive learning. Writtent in C++ with bindings for python and other languages.
...
* [OpenNN](https://github.com/Artelnics/OpenNN) ⭐ 1,198 | 🐛 0 | 🌐 C++ | 📅 2026-09-17 a neural network C++ library
...
* [AIMA python](https://github.com/aimacode/aima-python) ⭐ 8,834 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-06-30 Python code for the book [Artificial Intelligence: A Modern Approach](https://www.amazon.co.uk/Artificial-Intelligence-Approach-Stuart-Russell/dp/1292153962)
...
* [huggingface/transformers](https://github.com/huggingface/transformers) ⭐ 166,446 | 🐛 2,431 | 🌐 Python | 📅 2026-09-21 State-of-the-art Natural Language Processing for Pytorch and TensorFlow 2.0
* [SpaCy](https://github.com/spacy-io/spaCy) ⭐ 33,910 | 🐛 245 | 🌐 Python | 📅 2026-08-24 is a powerful, production ready, NLP library for python
* [fastText](https://github.com/facebookresearch/fastText) ⚠️ Archived a C++ library for sentence classification
* [Natural Language Toolkit](https://github.com/nltk/nltk) ⭐ 14,721 | 🐛 256 | 🌐 Python | 📅 2026-09-21 (NLTK) is a suite of python modules, data sets and tutorials supporting research and development in [NLP][]. Some of its modules are out of date but still a useful resource nonetheless.
* [TextBlob](https://github.com/sloria/TextBlob) ⭐ 9,548 | 🐛 71 | 🌐 Python | 📅 2026-09-15 is a python library for processing textual data. It provides a simple API for diving into common [NLP][] tasks such as part-of-speech tagging, noun phrase extraction, sentiment analysis, classification, translation, and more.
...
* [dataprofiler](https://github.com/capitalone/DataProfiler) ⭐ 1,586 | 🐛 80 | 🌐 Python | 📅 2026-09-14 The DataProfiler is a Python library designed to make data analysis, monitoring and sensitive data detection easy. NLP processing is accomplished using a character-level CNN.
...
* [Oxford Deep NLP 2017 course](https://github.com/oxford-cs-deepnlp-2017/lectures) ⭐ 15,855 | 🐛 12 | 📅 2023-07-02 lecture slides and course description for the Deep Natural Language Processing course
...
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,703 | 🐛 581 | 🌐 JavaScript | 📅 2026-09-14 HTML5 Charts using the canvas tag
* [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,337 | 🐛 779 | 🌐 JavaScript | 📅 2026-09-17 charting library built on top of [d3][] and [stack.gl](http://stack.gl/)
* [frappe/charts](https://github.com/frappe/charts) ⭐ 15,082 | 🐛 147 | 🌐 JavaScript | 📅 2025-07-02 Simple, responsive, modern SVG Charts with zero dependencies
* [G2](https://github.com/antvis/g2) ⭐ 12,612 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-20 is a visualization grammar, a data-driven visual language with a high level of usability and scalability
...
* [dash](https://github.com/plotly/dash/) ⭐ 24,420 | 🐛 472 | 🌐 Python | 📅 2026-09-18 Dash is a Python framework for building analytical web applications
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 322,006 | 🐛 19 | 🌐 Python | 📅 2026-09-20 A curated list of awesome Python frameworks, libraries, software and resources.
* [Interactive coding challenges](https://github.com/donnemartin/interactive-coding-challenges) ⭐ 31,837 | 🐛 75 | 🌐 Python | 📅 2024-05-08 which focus on algorithms and data structures that are typically found in coding interviews
